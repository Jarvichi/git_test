...
- [x] **#184** Settings: text size setting doesn't change anything — apply `zoom` to `.game-container` scaled by textSize/14; compensate height
- [x] **#185** Settings: text colour setting doesn't change anything — fix circular CSS variable `--game-text-color: var(--game-text-color)` → `#33ff33`
